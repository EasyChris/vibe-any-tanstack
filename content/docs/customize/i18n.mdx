...
VibeAny uses [Intlayer](https://intlayer.org/) as its internationalization solution. Compared to Next.js's `next-intl`, Intlayer's key advantage is full type safety, giving you an excellent development experience.
